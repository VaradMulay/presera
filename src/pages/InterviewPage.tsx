...
export default function InterviewPage() {
  ...
  if (!question) {
    return (
      <div className="mx-auto max-w-md py-20 text-center">
        <h2 className="text-lg font-bold text-neutral-900">No more questions.</h2>
        <Button to="/dashboard" className="mt-6">Back to dashboard</Button>
      </div>
    );
  }
  ...
  return (
    <div className="mx-auto max-w-3xl">
      <div className="mb-6">
        <h1 className="text-xl font-bold tracking-tight text-neutral-900">Mock Interview in Progress</h1>
