  ...
  return (
    <div className="flex min-h-screen bg-white">
      ...
      <div className="flex w-full flex-col px-6 py-8 sm:px-10 lg:w-1/2 lg:px-16">
        <Link to="/" className="inline-flex items-center gap-1.5 text-sm font-medium text-neutral-500 transition hover:text-neutral-900">
          <ArrowLeft className="h-4 w-4" /> Back to home
        </Link>

        <div className="mx-auto flex w-full max-w-sm flex-1 flex-col justify-center py-10">
          <Logo size="lg" />
          <h1 className="mt-8 text-2xl font-extrabold tracking-tight text-neutral-900">{title}</h1>
      ...
      <div className="relative hidden w-1/2 flex-col justify-between overflow-hidden bg-neutral-900 p-12 lg:flex">
        <div
          className="absolute -right-24 -top-24 h-96 w-96 rounded-full bg-brand-600/30 blur-3xl"
          aria-hidden
        />
        <div
          className="absolute -bottom-32 -left-20 h-96 w-96 rounded-full bg-accent-600/20 blur-3xl"
          aria-hidden
        />
        ...
        <div className="relative rounded-2xl border border-white/10 bg-white/5 p-5 backdrop-blur-sm">
          ...
          <div className="mt-4 flex items-center gap-3">
            <div className="flex h-9 w-9 items-center justify-center rounded-full bg-brand-500 text-sm font-bold text-white">P</div>
            <div>
